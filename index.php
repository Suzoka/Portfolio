    ...
    <div class="wrapper">
        ...
        <main>
            ...
            <section class="content">
                ...
                <p>Je m'appel Morgan, et suis étudiant en <span class="bold">BUT MMI</span>. Dans cette filière, j'ai
                    choisis de suivre le parcours <span class="bold">"Développement Web et dispositifs
                        intéractifs"</span>. Vous trouverez dans ce portfolio différents de mes projets, qu'ils soient
                    personnels ou scolaire. <br><br> Avec ce portfolio, vous avez un moyen de plonger dans ce que je
                    suis capable de faire ! <br><br>J'espère sincèrement que cette exploration à travers mon univers
                    vous plaira.</p>
